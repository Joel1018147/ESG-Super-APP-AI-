...
const suites = ['scoring-engine-test.js', 'no-model-figures-test.js', 'schema-idempotency-test.js', 'layer2-test.js', 'carbon-import-test.js', 'sedg-import-test.js', 'sedg-ui-test.js', 'green-finance-register-test.js', 'no-fallbacks-test.js', 'framework-choice-test.js', 'no-new-fallbacks.js', 'no-fallbacks-tree.js'];
let failed = 0;
