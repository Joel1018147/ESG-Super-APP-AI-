'use strict';
/* ═══════════════════════════════════════════════════════════════════════════
   NEGATIVE CONTROLS FOR THE DASHBOARD                              (Run 55)
   ───────────────────────────────────────────────────────────────────────────
   Every guard dashboard-test.js added in Run 55 is shown the exact defect it
   claims to catch, and must go RED. This is the pattern
   ...
   test/dashboard-test.js and public/css/modus-design-system.css in place and
   restores them afterwards, which is safe on a clean tree and destructive on a
   dirty one. A guard that can eat uncommitted work does not belong in the
...
const TOUCHED = ['src/routes/pages.js', 'test/dashboard-test.js', 'public/css/modus-design-system.css'];
try {
